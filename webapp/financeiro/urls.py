...
urlpatterns = [
    ...
    path('contas-bancarias/view/<int:id>', views.contas_bancarias_view, name='contasbancarias'),
    path('contas-bancarias/add/', views.contas_bancarias_add, name='contasbancarias'),
    path('contas-bancarias/edit/<int:id>', views.contas_bancarias_edit, name='contasbancarias'),
    path('contas-bancarias/delete/<int:id>', views.contas_bancarias_delete, name='contasbancarias'),
    ...
    path('planos-contas/view/<int:id>', views.plano_de_contas_view, name='planocontas'),
    path('planos-contas/add/', views.plano_de_contas_add, name='planocontas'),
    path('planos-contas/edit/<int:id>', views.plano_de_contas_edit, name='planocontas'),
    path('planos-contas/delete/<int:id>', views.plano_de_contas_delete, name='planocontas'),
    ...
    path('formas-pagamento/view/<int:id>', views.formas_pagamento_view, name='formaspagamento'),
    path('formas-pagamento/add/', views.formas_pagamento_add, name='formaspagamento'),
    path('formas-pagamento/edit/<int:id>', views.formas_pagamento_edit, name='formaspagamento'),
    path('formas-pagamento/delete/<int:id>', views.formas_pagamento_delete, name='formaspagamento'),
    ...
    path('tesouraria/view/<int:id>', views.tesouraria_view, name='tesouraria'),
    path('tesouraria/add/', views.tesouraria_add, name='tesouraria'),
    path('tesouraria/edit/<int:id>', views.tesouraria_edit, name='tesouraria'),
    path('tesouraria/delete/<int:id>', views.tesouraria_delete, name='tesouraria'),
